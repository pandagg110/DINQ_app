...
class ScholarComparePage extends StatelessWidget {
  const ScholarComparePage({super.key});
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  const Text('Scholar Compare', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
