...
class LinkedInComparePage extends StatelessWidget {
  const LinkedInComparePage({super.key});
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  const Text('LinkedIn Compare', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
