...
class InstagramHoverCard extends StatefulWidget {
  const InstagramHoverCard({
    super.key,
  ...
  @override
  State<InstagramHoverCard> createState() => _InstagramHoverCardState();
}

class _InstagramHoverCardState extends State<InstagramHoverCard> {
