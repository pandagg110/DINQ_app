...
class HuggingFaceWidget extends StatelessWidget {
  const HuggingFaceWidget({super.key, required this.card, required this.size});
  ...
  Widget build(BuildContext context) {
    ...
    switch (size) {
      ...
      case '2x4':
        return HuggingFaceLayouts.build2x4Layout(featuredRepo: featuredRepo);
      case '4x2':
        return HuggingFaceLayouts.build4x2Layout(featuredRepo: featuredRepo);
      case '4x4':
